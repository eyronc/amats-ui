  ...
  return (
    <div className="space-y-6 font-inter">
      ...
      <div className="space-y-4">
        {/* Search Bar - Improved positioning */}
          ...
          >
            ...
            <CardContent className={`p-4 ${viewMode === 'list' ? 'flex-1 flex flex-col justify-between' : ''}`}>
              <div className="space-y-3">
                {/* Product Info */}
                <div>
                  <h3 className="font-semibold text-lg font-manrope hover:text-primary transition-colors">
                    {product.name}
                  </h3>
              ...
              {/* Price and Add to Cart - Fixed alignment */}
              <div className={`flex items-center justify-between pt-4 mt-auto ${viewMode === 'list' ? 'border-t' : ''}`}>
                <div className="flex items-center space-x-2">
                ...
                <Button
                  ...
                  className="flex items-center space-x-2 font-manrope flex-shrink-0"
