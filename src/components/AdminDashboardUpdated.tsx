...
// Consistent fake user data - stored globally to avoid randomization
const FAKE_USER_DATA = {
  'maria@transport.com': {
    ...
    bio: 'Professional driver with 8 years of experience in the transport industry.',
    company: 'Manila Transit Corp',
    phone: '+63 912 345 6789',
    lastLogin: '2024-02-15 08:30 AM',
    totalDrives: 1247,
    averageDriveTime: '6.5 hours',
    emergencyContacts: ['Juan Fernandez (+63 912 345 6780)', 'Ana Santos (+63 912 345 6781)'],
    vehicleAssigned: 'Bus #MT-2024',
    route: 'EDSA - Quezon Ave'
  },
  'juan@logistics.com': {
    id: 2,
    name: 'Juan Hernandez',
    type: 'Fleet Manager',
    email: 'juan@logistics.com',
    status: 'active',
    joinDate: '2024-01-20',
    vehicles: 25,
    safetyScore: 89,
    country: 'Philippines',
    profileImage: 'https://images.unsplash.com/photo-1648448942225-7aa06c7e8f79?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmaWxpcGlubyUyMG1hbiUyMGJ1c2luZXNzJTIwbWFuYWdlcnxlbnwxfHx8fDE3NTg0NTMxNjd8MA&ixlib=rb-4.1.0&q=80&w=1080',
    bio: 'Fleet manager overseeing transportation operations for Metro Manila routes.',
    company: 'Logistics Solutions Inc.',
    phone: '+63 917 888 9999',
    lastLogin: '2024-02-15 09:15 AM',
    totalFleetSize: 45,
    activeDrivers: 38,
    monthlyMileage: '125,000 km',
    emergencyContacts: ['Rosa Hernandez (+63 917 888 9998)', 'Carlos Mendoza (+63 917 888 9997)'],
    fleetTypes: ['Buses', 'Trucks', 'Vans'],
    operatingAreas: ['Metro Manila', 'Laguna', 'Cavite']
  },
  'anna@delivery.com': {
    id: 3,
    name: 'Anna Villanueva',
    type: 'Driver',
    email: 'anna@delivery.com',
    status: 'active',
    joinDate: '2024-02-01',
    alerts: 8,
    safetyScore: 88,
    country: 'Philippines',
    profileImage: 'https://images.unsplash.com/photo-1740153204804-200310378f2f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhc2lhbiUyMHdvbWFuJTIwcHJvZmVzc2lvbmFsJTIwaGVhZHNob3R8ZW58MXx8fHwxNzU4NDUzMTczfDA&ixlib=rb-4.1.0&q=80&w=1080',
    bio: 'Delivery driver specializing in express logistics and time-sensitive deliveries.',
    company: 'FastDelivery Services',
    phone: '+63 905 123 4567',
    lastLogin: '2024-02-15 07:45 AM',
    totalDeliveries: 892,
    averageDeliveryTime: '45 minutes',
    emergencyContacts: ['Miguel Villanueva (+63 905 123 4566)', 'Elena Cruz (+63 905 123 4568)'],
    vehicleAssigned: 'Delivery Van #FD-0123',
    deliveryArea: 'Makati - BGC - Ortigas'
  },
  'carlos@cargo.com': {
    id: 4,
    name: 'Carlos Mercado',
    type: 'Fleet Manager',
    email: 'carlos@cargo.com',
    status: 'suspended',
    joinDate: '2024-01-10',
    vehicles: 45,
    safetyScore: 75,
    suspendedBy: 'admin@amats.com',
    suspensionDuration: 30,
    country: 'Philippines',
    profileImage: 'https://images.unsplash.com/photo-1648448942225-7aa06c7e8f79?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmaWxpcGlubyUyMG1hbiUyMGJ1c2luZXNzJTIwbWFuYWdlcnxlbnwxfHx8fDE3NTg0NTMxNjd8MA&ixlib=rb-4.1.0&q=80&w=1080',
    bio: 'Senior fleet manager with expertise in heavy cargo transportation.',
    company: 'Cargo Masters Philippines',
    phone: '+63 928 777 8888',
    lastLogin: '2024-02-10 02:30 PM',
    totalFleetSize: 78,
    activeDrivers: 62,
    monthlyMileage: '200,000 km',
    emergencyContacts: ['Isabel Mercado (+63 928 777 8887)', 'Roberto Santos (+63 928 777 8889)'],
    fleetTypes: ['Heavy Trucks', 'Container Trucks', 'Cargo Vans'],
    operatingAreas: ['Luzon', 'Visayas', 'Mindanao'],
    suspensionReason: 'Multiple safety violations reported by drivers under supervision'
  },
  'sofia@fasttrack.ph': {
    id: 5,
    name: 'Sofia Gutierrez',
    type: 'Driver',
    email: 'sofia@fasttrack.ph',
    status: 'active',
    joinDate: '2024-01-25',
    alerts: 1,
    safetyScore: 93,
    country: 'Philippines',
    profileImage: 'https://images.unsplash.com/photo-1736939678218-bd648b5ef3bb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmaWxpcGlubyUyMHdvbWFuJTIwYnVzaW5lc3MlMjBwcm9mZXNzaW9uYWx8ZW58MXx8fHwxNzU4NDUzMTYwfDA&ixlib=rb-4.1.0&q=80&w=1080',
    bio: 'Experienced courier driver with excellent safety record and customer service.',
    company: 'FastTrack Courier Services',
    phone: '+63 916 555 7777',
    lastLogin: '2024-02-15 10:20 AM',
    totalDeliveries: 1456,
    averageDeliveryTime: '35 minutes',
    emergencyContacts: ['Diego Gutierrez (+63 916 555 7776)', 'Carmen Lopez (+63 916 555 7778)'],
    vehicleAssigned: 'Motorcycle #FT-2024',
    deliveryArea: 'Metro Manila - NCR'
  }
};
...
export function AdminDashboard({ user, onLogout, registeredUsers, analytics, onUserManagement }: AdminDashboardProps) {
  ...
  // Initialize fake user statuses on component mount
  useEffect(() => {
    ...
    Object.values(FAKE_USER_DATA).forEach(userData => {
      initialStatuses[userData.email] = {
        ...
        suspensionDuration: userData.suspensionDuration
      };
    });
    setFakeUserStatuses(initialStatuses);
  }, []);

  // Combine real registered users with consistent fake data
  const mockUsers = [
  ...
  const handleUserAction = (action: string, userEmail: string, userData?: any) => {
    if (action === 'view') {
      // For fake users, use the consistent data from FAKE_USER_DATA
      const userToShow = userData.isRealTime ? userData : ((FAKE_USER_DATA as Record<string, any>)[userEmail] || userData);
  ...
  const confirmDeleteUser = () => {
    if (userToDelete) {
      if (userToDelete.userData.isRealTime) {
        ...
        // Handle fake user deletion by changing status
        setFakeUserStatuses(prev => ({
          ...prev,
          [userToDelete.email]: {
            status: 'terminated',
  ...
  const handleDeleteReport = (reportId: number) => {
    setDeletedReports(prev => [...prev, reportId]);
  ...
  const filteredReports = reports.filter(report => !deletedReports.includes(report.id));
              ...
              <CardContent>
                <div className="space-y-4 max-h-[70vh] overflow-y-auto">
                  {filteredUsers.map((userData) => (
                    <div key={userData.id || userData.email} className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 border rounded-lg space-y-4 sm:space-y-0">
                      <div className="flex items-center space-x-4">
          ...
          <TabsContent value="monitoring" className="space-y-6 w-full">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {filteredUsers.filter(u => u.type === 'Driver').slice(0, 4).map((driver) => (
                      <div key={driver.id || driver.email} className="flex items-center justify-between p-3 bg-muted/30 rounded-lg">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <div className="flex items-center space-x-1 mt-1">
                              <Badge variant={driver.alerts > 5 ? 'destructive' : driver.alerts > 2 ? 'secondary' : 'default'} className="text-xs">
